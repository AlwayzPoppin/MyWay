...
/**
 * Formats distance between two locations in feet or miles
 */
export const formatDistanceFromUser = (userLoc: Location | null | undefined, placeLoc: Location): string | null => {
    if (!userLoc) return null;
    const miles = getDistanceMiles(userLoc, placeLoc);
