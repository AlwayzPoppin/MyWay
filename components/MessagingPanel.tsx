...
const MessagingPanel: React.FC<MessagingPanelProps> = ({ members, currentUserId, onClose, theme }) => {
    const [messages, setMessages] = useState<Message[]>([
        ...
        },
        {
            ...
            senderId: '3',
            senderName: 'Chloe',
            senderAvatar: 'https://i.pravatar.cc/150?u=chloe',
            content: 'Soccer practice ends at 6pm',
    ...
    const sendMessage = (content: string, type: Message['type'] = 'text') => {
        ...
        const newMsg: Message = {
            ...
            senderName: 'You',
            senderAvatar: members.find(m => m.id === currentUserId)?.avatar || '',
            content,
            timestamp: new Date(),
            type
        };
    ...
    const sendLocationShare = () => {
        ...
        if (currentMember) {
            sendMessage(`📍 Shared my location: ${currentMember.currentPlace || 'Current location'}`, 'location');
        }
    };
